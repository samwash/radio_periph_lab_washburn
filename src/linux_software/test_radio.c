...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    unsigned int clocks = stop_time - start_time;
    ...
    float bytes_transferred = 4.0 * 2048.0; // change obviously
    float time_spent = ((float) clocks) / 125000000.0; // change obviously
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Samuel Washburn - Custom Peripheral Demonstration\n\r");
